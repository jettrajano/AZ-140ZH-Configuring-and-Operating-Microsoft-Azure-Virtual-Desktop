...
- 已完成实验室 **“准备部署 Azure Windows 虚拟桌面 (Azure AD DS)”**
...
- 在 Azure AD DS 域中配置 Azure Windows 虚拟桌面环境。 
- 在 Azure AD DS 域中验证 Azure Windows 虚拟桌面环境。 
...
1. 在实验室计算机的 Azure 门户中，搜索并选择 **“虚拟机”**，然后在 **“虚拟机”** 边栏选项卡中，选择 **“az140-cl-vm11a”** 条目**。此时会打开 **“az140-cl-vm11a”** 边栏选项卡。
1. 在 **“az140-cl-vm11a”** 边栏选项卡中，在工具栏上选择 **“连接”**，在下拉菜单中选择 **“RDP”**，在 **“RDP”** 选项卡上，其位于 **“az140-cl-vm11a \| 连接”** 边栏选项卡中，在 **“IP 地址”** 下拉列表中选择 **“公共 IP 地址”** 条目，然后选择 **“下载 RDP 文件”**。
1. 系统出现提示时，请使用以下凭据登录：
...
1. 在 **az140-cl-vm11a Azure** VM 的远程桌面中，启动 Microsoft Edge，导航到 [Azure 门户](https://portal.azure.com)，然后通过提供 **aadadmin1** 用户帐户的用户主体名称（**Pa55w.rd1234** 作为其密码）进行登录。
...
1. 在与 **az140-cl-vm11a** 的远程桌面会话中，在显示 Azure 门户的 Microsoft Edge 窗口中，搜索并选择 **“Windows 虚拟桌面”**，在 **“Windows 虚拟桌面”** 边栏选项卡左侧垂直菜单的 **“管理”** 部分中，选择 **“主机池”**，然后在 **“Windows 虚拟桌面 \| 主机池”** 边栏选项卡上选择 **“+ 创建”**。 
...
1. 在 **“创建主机池”** 边栏选项卡的 **“虚拟机”** 选项卡中，指定以下设置并选择 **“下一步:工作区 >”** （将 *<Azure_AD_domain_name>* 占位符替换为与部署 Azure AD DS 实例的订阅关联的 Azure AD 租户的名称）：
...
#### 任务 3：配置 Windows 虚拟桌面应用程序组

1. 在与 **az140-cl-vm11a** 的远程桌面会话中，在 Azure 门户中，搜索并选择 **“Windows 虚拟桌面”**，然后在 **“Windows 虚拟桌面”** 边栏选项卡上，选择 **“应用程序组”**。
1. 在 **“Windows 虚拟桌面 \| 应用程序组”** 边栏选项卡上，选择自动生成的 **az140-21a-hp1-DAG** 桌面应用程序组。
...
1. 导航回到 **“Windows 虚拟桌面 \| 应用程序组”** 边栏选项卡，然后再次选择 **“+ 创建”**。
...
1. 返回 **“创建应用程序组”** 边栏选项卡的 **“应用程序”** 选项卡，选择 **“+ 添加应用程序”**。
1. 在 **“添加应用程序”** 边栏选项卡上，指定以下设置并选择 **“保存”**：
...
1. 在与 **az140-cl-vm11a** 的远程桌面会话中，搜索并选择 **“Windows 虚拟桌面”**，然后在 **“Windows 虚拟桌面”** 边栏选项卡上，选择 **“应用程序组”**。
1. 在 **“Windows 虚拟桌面 \| 应用程序组”** 边栏选项卡上，选择 **“+ 创建”**。 
1. 在 **“创建应用程序组”** 边栏选项卡的 **“基本信息”** 选项卡中，指定以下设置并选择 **“下一步:应用程序 >”**：
...
#### 任务 4：配置 Windows 虚拟桌面工作区

1. 在与 **az140-cl-vm11a** 的远程桌面会话中，在显示 Azure 门户的 Microsoft Edge 窗口，搜索并选择 **“Windows 虚拟桌面”**，并在 **“Windows 虚拟桌面”** 边栏选项卡中选择 **“工作区”**。
1. 在 **“Windows 虚拟桌面 \| 工作区”** 边栏选项卡中，选择 **“+ 创建”**。 
...
1. 在 **“创建工作区”** 边栏选项卡的 **“工作区”** 选项卡上，选择 **“+ 注册应用程序组”**。
...
1. 在命令提示符下，键入**主机名并**按 **Enter** 键以显示运行命令提示符的计算机的名称。
...
1. 在**默认桌面**会话中，在命令提示符下键入**主机名**并按 **Enter** 键以显示运行远程桌面会话的计算机的名称。
