...
- 在 AD DS 域中实现 Azure Windows 虚拟桌面环境
- 在 AD DS 域中验证 Azure Windows 虚拟桌面环境
...
### 练习 1：在 AD DS 域中实现 Azure Windows 虚拟桌面环境
  
本练习的主要任务如下：

1. 准备 AD DS 域和 Azure 订阅，以部署 Azure Windows 虚拟桌面主机池
1. 部署 Azure Windows 虚拟桌面主机池
1. 管理 Azure Windows 虚拟桌面主机池会话主机
1. 配置 Windows 虚拟桌面应用程序组
1. 配置 Windows 虚拟桌面工作区

#### 任务 1：准备 AD DS 域和 Azure 订阅，以部署 Azure Windows 虚拟桌面主机池

1. 在实验室计算机上，启动 Web 浏览器，导航至 [Azure 门户]( )，然后通过提供你将在本实验室使用的订阅中具有所有者角色的用户帐户凭据进行登录。
1. 在 Azure 门户中，搜索并选择 **“虚拟机”**，然后从 **“虚拟机”** 边栏选项卡中选择 **“az140-dc-vm11”**。
...
1. 在与 **az140-dc-vm11** 的远程桌面会话中，从 **“管理员:Windows PowerShell ISE”** 控制台运行以下命令，创建一个组织单位，该组织单位将托管 Windows 虚拟桌面主机的计算机对象：

   ```powershell
   New-ADOrganizationalUnit 'WVDInfra' 朴ath 'DC=adatum,DC=com' -ProtectedFromAccidentalDeletion $false
   ```
...
1. 在 **“az140-adds-vnet11”** 边栏选项卡上，选择 **“子网”**，在 **“子网”** 边栏选项卡中选择 **“+ 子网”**，在 **“添加子网”** 边栏选项卡上，指定以下设置（所有其他设置请保留默认值），并单击 **“保存”**：
...
#### 任务 2：部署 Azure Windows 虚拟桌面主机池

1. 在与 **az140-dc-vm11** 的远程桌面会话中，在显示 Azure 门户的 Microsoft Edge 窗口，搜索并选择 **“Windows 虚拟桌面”**，在 **“Windows 虚拟桌面”** 边栏选项卡上，选择 **“主机池”**，在 **“Windows 虚拟桌面 \| 主机池”** 边栏选项卡上，选择 **“+ 添加”**。 
...
#### 任务 3：管理 Azure Windows 虚拟桌面主机池会话主机

1. 在与 **az140-dc-vm11** 的远程桌面会话中，在显示 Azure 门户的 Web 浏览器窗口中，搜索并选择 **“Windows 虚拟桌面”**，在 **“Windows 虚拟桌面”** 边栏选项卡上，在垂直菜单栏的 **“管理部分”** 中，选择 **“主机池”**。
1. 在 **“Windows 虚拟桌面 \| 主机池”** 边栏选项卡的主机池列表中，选择 **“az140-21-hp1”**。
...
1. 在 **“将虚拟机添加到主机池”** 边栏选项卡的 **“虚拟机”** 选项卡中，指定以下设置并选择 **“查看 + 创建”**：
...
1. 在 **“将虚拟机添加到主机池”** 边栏选项卡的 **“查看 + 创建”** 选项卡中，选择 **“创建”**
   ...
   > **备注**：请勿等待部署完成，而是继续进行下一项任务。该部署可能需要 5 分钟左右。 

#### 任务 4：配置 Windows 虚拟桌面应用程序组

1. 在与 **az140-dc-vm11** 的远程桌面会话中，在显示 Azure 门户的 Web 浏览器窗口中，搜索并选择 **“Windows 虚拟桌面”**，在 **“Windows 虚拟桌面”** 边栏选项卡上，选择 **“应用程序组”**。
1. 在 **“Windows 虚拟桌面 \| 应用程序组”** 边栏选项卡上，注意现有的自动生成的 **az140-21-hp1-DAG** 桌面应用程序组，并选择它。 
...
1. 导航回到 **“Windows 虚拟桌面 \| 应用程序组”** 边栏选项卡上，选择 **“+ 添加”**。 
...
1. 在与 **az140-dc-vm11** 的远程桌面会话中，搜索并选择 **“Windows 虚拟桌面”**，在 **“Windows 虚拟桌面”** 边栏选项卡上，选择 **“应用程序组”**。
1. 在 **“Windows 虚拟桌面 \| 应用程序组”** 边栏选项卡上，选择 **“+ 添加”**。 
1. 在 **“创建应用程序组”** 边栏选项卡的 **“基本信息”** 选项卡中，指定以下设置并选择 **“下一步:应用程序 >”**：
...
#### 任务 5：配置 Windows 虚拟桌面工作区

1. 在与 **az140-dc-vm11** 的远程桌面会话中，在显示 Azure 门户的 Microsoft Edge 窗口中，搜索并选择 **“Windows 虚拟桌面”**，在 **“Windows 虚拟桌面”** 边栏选项卡上，选择 **“工作区”**。
1. 在 **“Windows 虚拟桌面 \| 工作区”** 边栏选项卡上，选择 **“+ 添加”**。 
...
### 练习 2：验证 Azure Windows 虚拟桌面环境
  
本练习的主要任务如下：

1. 在 Windows 10 计算机上安装 Microsoft 远程桌面客户端 (MSRDC)
1. 订阅 Windows 虚拟桌面工作区
1. 测试 Windows 虚拟桌面应用
...
1. 在与 **az140-dc-vm11** 远程桌面会话中，从 **“管理员:Windows PowerShell ISE”** 脚本窗格中，运行以下命令，将 **ADATUM\\az140-wvd-users** 的所有成员添加到本地 **“远程桌面用户”** 组，该组位于运行你在实验室 **“准备部署 Azure Windows 虚拟桌面 (AD DS)”** 中部署的 Windows 10 的 **Azure VM az140-cl-vm11** 上。
...
1. 切换到实验室计算机，并在显示 Azure 门户的 Web 浏览器窗口中，在 **“Cloud Shell”** 窗格中启动 **“PowerShell”** Shell 会话。
