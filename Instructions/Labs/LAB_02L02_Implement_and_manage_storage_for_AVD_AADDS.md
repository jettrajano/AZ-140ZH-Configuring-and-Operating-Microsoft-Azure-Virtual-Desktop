...
1. 在与 **az140-cl-vm11a** 的远程桌面会话中，在 Microsoft Edge 窗口的 Azure 门户中，在显示你在先前任务中创建的存储帐户属性的边栏选项卡上，在左侧垂直菜单的“**存储**”部分中选择“**文件共享**”。 
1. 在“**文件共享设置**”部分，选择“**Active Directory**”标签旁边的“**未配置**”链接。
1. 在“**启用 Active Directory 源**”部分，在标记为“**Azure Active Directory 域服务**”的框中，选择“**设置**”。
1. 在“**基于标识的访问**”边栏选项卡中，选择“**启用**”选项，然后选择“**保存**”。
