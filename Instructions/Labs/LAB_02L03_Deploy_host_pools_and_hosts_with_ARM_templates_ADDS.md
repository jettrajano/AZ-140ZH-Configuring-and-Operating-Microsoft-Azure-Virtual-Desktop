...
1. 返回 **“自定义部署”** 边栏选项卡，指定以下设置（其他设置保留现有值）：
   ...
   |位置|实验室 **“准备部署 Azure 虚拟桌面 (AD DS)”** 中向其部署托管 AD DS 域控制器的 Azure VM 的 Azure 区域的名称|
...
1. 切换回与 **az140-cl-vm11** 的远程桌面会话，在 **“远程桌面”** 窗口中，单击右上角 **“Azure 虚拟桌面”** 标签旁边的省略号图标，在下拉菜单中，单击 **“取消订阅”**，并在出现确认提示时，单击 **“继续”**。
