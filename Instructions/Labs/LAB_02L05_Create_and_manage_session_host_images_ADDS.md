...
你需要在 Active Directory 域服务 (AD DS) 环境中创建和管理 Windows 虚拟桌面主机映像。
...
1. 准备配置 Windows 虚拟桌面主机映像
1. 配置 Windows 虚拟桌面主机映像
1. 创建 Windows 虚拟桌面主机映像
1. 使用自定义映像预配 Windows 虚拟桌面主机池。

#### 任务 1：准备配置 Windows 虚拟桌面主机映像
...
1. 在实验室计算机显示 Azure 门户的 Web 浏览器中，从 **“Cloud Shell”** 窗格内的 PowerShell 会话运行以下命令，以创建将包含 Windows 虚拟桌面主机映像的资源组：
...
1. 在 Azure 门户的 Cloud Shell 窗格的工具栏中，选择上传/下载文件图标，在下拉菜单中选择 **“上传”**，然后将文件 **“\\\\AZ-140\\AllFiles\\Labs\\02\\az140-25_azuredeployvm25.json”** 和 **“\\\\AZ-140\\AllFiles\\Labs\\02\\az140-25_azuredeployvm25.parameters.json”** 上传到 Cloud Shell 主目录中。
...
#### 任务 2：配置 Windows 虚拟桌面主机映像

1. 在 Azure 门户中，搜索并选择 **“虚拟机”**，然后在 **“虚拟机”** 边栏选项卡上，选择 **“az140-25-vm0”**。
1. 在 **“az140-25-vm0”** 边栏选项卡中，选择 **“连接”**，在下拉菜单中选择 **“RDP”**，在 **“az140-25-vm0 \| 连接”** 边栏选项卡上的 **“RDP”** 选项卡的 **“IP 地址”** 下拉列表中，选择 **“公共 IP 地址”** 条目，然后选择 **“下载 RDP 文件”**。
1. 系统出现提示时，请使用以下凭据登录：
...
1. 在与 **az140-25-vm0** 的远程桌面会话中，切换到 Microsoft Edge 窗口，然后浏览至[远程桌面 WebRTC 重定向程序服务下载页](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE4AQBt)，将安装程序包保存至 **“C:\\Allfiles\\Labs\\02”** 文件夹。
1. 在与 **az140-25-vm0** 的远程桌面会话中，启动文件资源管理器，然后导航至 **“C:\\Allfiles\\Labs\\02”** 文件夹，双击新下载的安装程序，使用默认的设置运行安装。
...
1. 在与 **az140-25-vm0** 的远程桌面会话中，在 **“管理员:C:\windows\system32\cmd.exe”** 窗口中，从命令提示符运行 Sysprep 实用工具，以便让操作系统准备好生成映像并自动将操作系统关闭：
   ...
   > **备注**：等待 Sysprep 过程完成。该过程大约需要 2 分钟。这会自动关闭操作系统。 
...
1. 在 **“创建映像”** 边栏选项卡的 **“基本”** 选项卡中，指定以下设置：
   ...
   |设置|值|
   |---|---|
   |将映像共享到共享映像库|**是的，将映像共享到库作为映像版本**|
   |创建映像后自动删除此虚拟机|复选框已清除|
   |目标映像库|新映像库名称 **az10425imagegallery**|
   |操作系统状态|**通用**|
...
1. 在实验室计算机显示 Azure 门户的 Web 浏览器中，搜索并选择 **“共享映像库”**，在 **“共享映像库”** 边栏选项卡上选择 **“az10425imagegallery”** 条目，然后在 **“az10425imagegallery”** 边栏选项卡上验证是否存在表示新建的映像的 **“az140-25-host-image”** 条目。

#### 任务 4：使用自定义映像预配 Windows 虚拟桌面主机池
...
1. 在实验室计算机显示 Azure 门户的 Web 浏览器中，搜索并选择 **“Windows 虚拟桌面”**，在 **“Windows 虚拟桌面”** 边栏选项卡上，选择 **“主机池”**，然后在 **“Windows 虚拟桌面 \| 主机池”** 边栏选项卡中，选择 **“+ 添加”**。 
