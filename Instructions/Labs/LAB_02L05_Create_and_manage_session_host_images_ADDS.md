...
1. 在 **“创建映像”** 边栏选项卡的 **“基本”** 选项卡中，指定以下设置：
   ...
   |目标映像库|新映像库名称 **az14025imagegallery**|
   |操作系统状态|**通用**|
...
1. 在实验室计算机显示 Azure 门户的 Web 浏览器中，搜索并选择“**共享映像库**”，在“**共享映像库**”边栏选项卡上选择“**az14025imagegallery**”条目，然后在“**az14025imagegallery**”边栏选项卡上验证是否存在表示新建的映像的“**az140-25-host-image**”条目。
