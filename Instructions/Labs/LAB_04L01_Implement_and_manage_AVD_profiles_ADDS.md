...
1. 在与 **az140-cl-vm11** 的远程桌面会话中，在“**远程桌面**”客户端窗口中，选择“**订阅**”，并在出现提示时使用“**aduser1**”凭据登录。
 ...
 >**备注** 如果没有要求你订阅，那么你可能需要取消之前的订阅。
3. 在应用程序列表中，双击“**命令提示符**”，在出现提示时，提供“**aduser1**”帐户的密码，并验证“**命令提示符**”窗口是否成功打开。
...
7. 在与 **az140-cl-vm11** 的远程桌面会话中，在“**远程桌面**”客户端窗口的应用程序列表中，双击 **az-140-21-s1** 下的“**SessionDesktop**”，并验证它是否启动了远程桌面会话。 
